...
const Firework = SuspenseLazy(() => import(/* webpackChunkName:"firework" */ '@/view/Home/Firework'));
// const Canvasworks = SuspenseLazy(() => import(/* webpackChunkName:"canvasworks" */ '@/view/canvasworks'));
const CanvasFirework = SuspenseLazy(
    () => import(/* webpackChunkName:"canvas-firework" */ '@/view/canvasworks/firework')
);
const CanvasSmog = SuspenseLazy(() => import(/* webpackChunkName:"canvas-smog" */ '@/view/canvasworks/smog'));
const CanvasSmoke = SuspenseLazy(() => import(/* webpackChunkName:"canvas-smoke" */ '@/view/canvasworks/smoke'));

const routes: RouteObject[] = [
    {
        path: '/',
        element: <Navigate to='home/firework' /> // 重定向
    },
    {
        path: 'home',
        element: Home,
